      ...
      <fiedset class="cllaa p-2">
                              <form role="form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input tyep="text" class="form-control" name="title" placeholder="Enter Article Title" value="<?php if(isset($cat['title'])){ echo $cat['title'];} ?>">
                                </div>
                                <div class="form-group">
                                    <label>Category Description</label>
                                    <textarea class="form-control" name="description" cols="55" rows="6"><?php if(isset($cat['description'])){ echo $cat['description'];} ?></textarea>
                                </div>
                                <div class="form-group">
                                   
                                    <input type="hidden" class="form-control" name="slug" placeholder="Enter Category Slug Here" value="<?php if(isset($cat['slug'])){ echo $cat['slug'];} ?>">
                                </div>
