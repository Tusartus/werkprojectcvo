			...
			<div class="col-md-12">
				<div class="billing-details">
					...
					<form method="post">
						...
						<input name="phone" class="form-control" placeholder="Phone Number" min="1" type="number" value="<?php if(isset($_POST['phone'])){ echo $_POST['phone']; } ?>">
						<div class="clearfix space20"></div>
						<input type="submit" value="Submit" class="button btn-lg m-3" />
					</form>
				</div>
			</div>
		</div>
