...
{
 $id = $_GET['edit_id'];
 $stmt_edit = $db->prepare('SELECT title, description,  pic FROM werking WHERE id = :id');
...
if(isset($_POST['save_updates'])){
      ...
      if(empty($_POST['description'])){$errors[] = "Content Field is Required";}
        ...
        if($imgFile)
        {
         $upload_dir ='../media-werking/'; // upload directory 
        ...
        if(!isset($errors)){
            $stmt = $db->prepare('UPDATE werking
        ...
        <fiedset class="claa p-2">
            <form role="form" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <img src='../media-werking/<?php echo $pic; ?>'  height='50px' width='100px'>
                </div>
