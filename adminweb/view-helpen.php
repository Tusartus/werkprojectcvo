 ...
 ?>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">
            <a class="text-info p-2" href="add-helpen.php"> add new </a>
...
?>         
                                ...
                                <tr>
                                    ...
                                    <td> 
                                    <a class="text-info" href="edit-helpen.php?edit_id=<?php echo $p['id'];?>">edit</a> |  
...
if(isset($_GET['delete_id']))
{
 ...
 $stmt_select = $db->prepare('SELECT pic FROM helpen WHERE id =:id');
 $stmt_select->execute(array(':id'=>$_GET['delete_id']));
 $imgRow=$stmt_select->fetch(PDO::FETCH_ASSOC);
 unlink("../media-helpen/".$imgRow['pic']);
 
 // it will delete an actual record from db
 $stmt_delete = $db->prepare('DELETE FROM helpen WHERE id =:pid');
...
if($stmt_delete->execute())
{
  ...
  window.location.href='view-helpen.php';
  </script>
  ";
