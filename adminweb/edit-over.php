...
{
 $id = $_GET['edit_id'];
 $stmt_edit = $db->prepare('SELECT title, description,  pic FROM overons WHERE id = :id');
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">
            <a class="text-info p-2" href="view-over.php"> view </a>
        ...
        <fiedset class="claa p-2">
            <form role="form" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <img src='../media-overons/<?php echo $pic; ?>'  height='50px' width='100px'>
                </div>
